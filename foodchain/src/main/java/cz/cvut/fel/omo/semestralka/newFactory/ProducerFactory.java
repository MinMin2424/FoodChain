...
public class ProducerFactory extends AbstractFactory{
    ...
    public void returnProduct(String productName, int returnQuantity) {
        ...
        createNewTransaction(product, Place.WAREHOUSE_PRODUCER, Place.VAN, OperationType.RETURN, returnQuantity);
        createNewTransaction(product, Place.VAN, Place.WAREHOUSE_FARMER, OperationType.TRANSPORT, returnQuantity);
    }
